...
import { Eraser, Feather, RefreshCw, Scissors } from 'lucide-react';
import RevealOnScroll from '@/components/ui/RevealOnScroll';
import StepsConnector from '@/components/ui/StepsConnector';

const TreatmentSection: React.FC = () => {
    const steps = [
        { icon: <Scissors size={32} />, title: "Desbastamento", desc: "Remoção técnica do excesso de queratina com bisturi, sem dor e sem cortes." },
        { icon: <Eraser size={32} />, title: "Lixamento Técnico", desc: "Acabamento com lixas rotativas para deixar a pele lisa e uniforme." },
        { icon: <RefreshCw size={32} />, title: "Hidratação", desc: "Aplicação de cremes com ureia de alta concentração para devolver a elasticidade." },
        { icon: <Feather size={32} />, title: "Alívio Imediato", desc: "Você já sai da sessão sentindo a diferença no pisar." }
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <RevealOnScroll variant="blur-up">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-4xl font-serif text-stone-900 mb-3">Como Removemos</h2>
                        <p className="text-xl text-stone-500 font-light max-w-2xl mx-auto">
                            Esqueça lixas manuais e pedras-pomes que agridem a pele. Nossa técnica é profissional, indolor e segura.
                        </p>
                    </div>
                </RevealOnScroll>
