            ...
            <div className="absolute inset-0 z-0">
                <RevealOnScroll variant="scale" className="w-full h-full">
                    <Image
                        ...
                        alt="Tratamento de Podologia Especializada em Campinas"
                        fill
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <RevealOnScroll variant="blur-up" delay={200}>
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-stone-900 mb-3 leading-none">
                        Podologia Especializada <br /><span className="text-brand-700 italic">em Campinas</span>
                    </h1>
                </RevealOnScroll>
                ...
                <RevealOnScroll variant="blur-up" delay={400}>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button onClick={() => window.open('https://wa.me/5519983690695', '_blank')} className="shadow-xl bg-black text-white hover:bg-stone-800 border-none">
                            Agendar Horário
                        </Button>
                        <Button
                            variant="outline"
