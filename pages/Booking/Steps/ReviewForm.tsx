...
Aguardo confirmação!`;
    ...
    // Codifica para URL
    const url = `https://wa.me/5519999999999?text=${encodeURIComponent(message)}`;
  ...
  return (
    <div className="max-w-xl mx-auto animate-fade-in-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-6">
            <Button fullWidth className="py-5 text-xl bg-green-600 hover:bg-green-700 shadow-xl border-none">
              Confirmar no WhatsApp
            </Button>
            <p className="text-center text-xs text-stone-400 mt-4">
              Ao clicar, você será redirecionada para o WhatsApp do consultório.
            </p>
        </div>
      </form>
    </div>
